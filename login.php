<?php 
 ...
 if(isset($_GET['status'])&&$_GET['status']=="true"){
    echo "<script>alert('bạn đã đăng nhập sai hoặc chưa nhập , yêu cầu bạn nhập lại')</script>";
 }
 if(isset($_GET['status'])&&$_GET['status']==2)
 {
    echo "<script>alert('Bạn đã đăng ký thành công tài khoản,mời bạn đăng nhập')</script>";
 }
 ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="login-form">
        <form class="loginTab signin" action="xulylogin.php" method="POST" >
