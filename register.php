<?php 
 ...
 {
    echo "<script>alert('tài khoản này đã tồn tại,mời đăng ký lại')</script>";
 }
...
<body>
    ...
    <div class="login-form">
        <form class="loginTab signup" action="xulyregister.php" method="POST">
          ...
          <!--   <div class="loginTab-input-password">
             ...
             <div class="loginTab-input-address">
                ...
                <div class="loginTab-input-fieldInput">
                    <input type="text" name="address" value="" required="" autofocus=""" placeholder="Address">
                </div>
            </div>
