<?php 
//xử lý csdl lấy tên list
include('connect.php');
$idusers=$_SESSION['iduser'];
$a2 = "SELECT * FROM tb_list where idUser='$idusers'";
$result2 = $conn->prepare($a2);
$result2->execute();
foreach ($result2 as $row) {
if($_SESSION['number_list']>0){
echo '<div class="list-icon" id="icon1">
...
<div class="namefoder">';echo $row['name'];echo'</div>
<input type="text" style="display:none;" name="idlist"';echo "value=".$row['id'].'>
</div>';
 }
}
?>